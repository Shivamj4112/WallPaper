...
class VehicleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVehicleBinding.inflate(layoutInflater)
        ...
        binding.neonRecyler.layoutManager =
            StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL)
        binding.neonRecyler.adapter = adapter

        key = dbRef.push().key!!
        dbRef.root.child("Image").child("Vehicle").addValueEventListener(object : ValueEventListener {
