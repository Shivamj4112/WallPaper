...
import com.custom.wallpaper.databinding.FragmentCartoonBinding
import com.custom.wallpaper.databinding.FragmentFlowerBinding
import com.custom.wallpaper.databinding.FragmentMaterialBinding
...
class MaterialFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        key = dbRef.push().key!!
        dbRef.root.child("Image").child("Material").addValueEventListener(object :
            ValueEventListener {
