...
import com.custom.wallpaper.databinding.FragmentBabyBinding
import com.custom.wallpaper.databinding.FragmentFestivalBinding
...
class FestivalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentFestivalBinding.inflate(layoutInflater)
        ...
        key = dbRef.push().key!!
        dbRef.root.child("Image").child("Festival").addValueEventListener(object :
            ValueEventListener {
